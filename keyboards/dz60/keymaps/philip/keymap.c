...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [TAB_FN] = LAYOUT(
    ...
    KC_TRNS, TG(MOUSE), RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,
    ...
    KC_TRNS, TO(BASE_WIN), TO(BASE_MAC), TG(MOUSE), TG(MOUSE), TG(MOUSE), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
  ...
  [MOUSE] = LAYOUT(
    ...
    KC_A, KC_LGUI, KC_LALT, TG(MOUSE), TG(MOUSE), TG(MOUSE), KC_A, KC_B, KC_TRNS, KC_TRNS, KC_D),
};
