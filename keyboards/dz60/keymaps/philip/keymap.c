...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE_WIN] = LAYOUT(
    ...
    MO(MOUSE), KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_A, KC_B, KC_TRNS, MO(LED), KC_D),
  ...
  [BASE_MAC] = LAYOUT(
    ...
    KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,
    KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_NO,
    MO(MOUSE), KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_SPC, KC_A, KC_B, KC_TRNS, MO(LED), KC_D),

  [TAB_FN] = LAYOUT(
    KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, RESET,
    KC_TRNS, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,
    ...
    KC_TRNS, TO(BASE_WIN), TO(BASE_MAC), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
  ...
  [MOUSE] = LAYOUT(
    ...
    KC_TAB, KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2, KC_R, KC_T, KC_Y, KC_WH_U, KC_MS_U, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSPC,
    KC_LCTL, KC_BTN1, KC_BTN2, KC_WH_D, KC_F, KC_G, KC_MS_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_SCLN, KC_QUOT, KC_ENT,
    KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TO(BASE_WIN), KC_NO,
    KC_A, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_A, KC_B, KC_TRNS, KC_TRNS, KC_D),
};
